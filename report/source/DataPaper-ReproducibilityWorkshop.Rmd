...
#Global code chunk for setting working directory

#Direct root directory to root project file
knitr::opts_knit$set(root.dir = rprojroot::find_rstudio_root_file())

#Setting global options for all code chunks
knitr::opts_chunk$set(results = FALSE, echo = FALSE, warning = FALSE, message = FALSE)
...
```{r fig3-heartrate, results = FALSE, echo = FALSE, warning = FALSE, message = FALSE, fig.cap = "Fig 3. Mean heart rate of stress and control groups at baseline and during intervention."}
#Call R script in code folder
#03_HR_analysis.R
...
#Read data
#Need to fix directory where this Rmd lives and where that R script lives
# df <- read.csv("output/data/preprocessed-GARP-TSST-data.csv", encoding = "UTF-8")
...
#Put in relative path to run code from code directory
#Want knitr fx to run this code
source("code/02_hormone_analysis.R", local = knitr::knit_global())

#Display figure, need to call plot
plot
```
